...
#define WINDOW_STYLE_NORMAL (WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_VISIBLE)
...
DeviceManager::CreateWindowDeviceAndSwapChain(const DeviceCreationParameters &params, LPWSTR title)
{
    ...
    ATOM hAtomWindowClass = RegisterClassEx(&windowClass);
