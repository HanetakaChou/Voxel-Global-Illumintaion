...
class MainVisualController : public IVisualController
{
    ...
    virtual void Render(RenderTargetView RTV) override
    {
        ...
        // Shadow Map
        {
            g_pRendererInterface->debugBeginEvent("Shadow Map");
            ...
            if (g_bEnableGI)
            {
                ...
                if (performOpacityVoxelization || performEmittanceVoxelization)
                {
                    ...
                    if (VXGI_SUCCEEDED(g_pGI->getInvalidatedRegions(regions, maxRegions, numRegions)))
                    {
                        ...
                        {
                            g_pRendererInterface->debugBeginEvent("Opacity Voxelization");
                        ...
                        {
                            g_pRendererInterface->debugBeginEvent("Emittance Voxelization");
        ...
        if (g_DebugRenderMode != VXGI::DebugRenderMode::DISABLED)
        {
            ...
            {
                g_pRendererInterface->debugBeginEvent("VXGI Lighting");
        ...
        else
        {
            ...
            if (g_bEnableGI)
            {
                ...
                {
                    g_pRendererInterface->debugBeginEvent("VXGI Diffuse Lighting");
                ...
                {
                    g_pRendererInterface->debugBeginEvent("VXGI Specular Lighting");
