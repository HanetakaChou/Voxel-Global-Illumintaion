...
class MainVisualController : public IVisualController
{
    ...
    virtual void Render(RenderTargetView RTV) override
    {
        ...
        else
        {
            ...
            {
                g_pRendererInterface->debugBeginEvent("VXGI Opaque");
                ...
                if (g_bEnableGI)
                {
                    ...
                    {
                        g_pRendererInterface->debugBeginEvent("VXGI Specular");
                ...
                {
                    g_pRendererInterface->debugBeginEvent("VXGI Transparent");
