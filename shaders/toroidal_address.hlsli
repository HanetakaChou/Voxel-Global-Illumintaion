...
#if VCT_PERSISTENT_VOXEL_DATA
	// assert(all(g_clipmap_level_toroidal_offsets[in_clipmap_level_index].xyz >= 0))
	// int3 clipmap_toroidal_address = ((clipmap_texel_space + g_clipmap_level_toroidal_offsets[clipmap_level_index].xyz) % int3(VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE) + int3(VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE)) % int3(VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE);
	int3 clipmap_toroidal_address = (clipmap_texel_space + g_clipmap_level_toroidal_offsets[clipmap_level_index].xyz) % int3(VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE, VCT_CLIPMAP_SIZE);
#else
	// fake
