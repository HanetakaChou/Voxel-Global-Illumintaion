...
#pragma warning(disable : 4201)
    ...
    struct Vector2
    {
        ...
        Vector2 &operator=(const Vector3<T> &b)
        {
            x = b.x;
            y = b.y;
            return *this;
        }
        Vector2 &operator=(const Vector4<T> &b)
        {
            x = b.x;
            y = b.y;
            return *this;
    ...
    Vector2<T> CastVector2(const Vector2<U> &a)
    {
    ...
    struct Vector3
    {
        ...
        Vector3 &operator=(const Vector4<T> &b)
        {
            x = b.x;
            y = b.y;
            z = b.z;
    ...
    template <typename T, typename U>
    Vector3<T> CastVector3(const Vector3<U> &a)
    {
    ...
    struct Vector4
    {
        ...
        Vector4 &operator=(const Vector3<T> &_V)
        {
            x = _V.x;
            y = _V.y;
            z = _V.z;
    ...
    template <typename T, typename U>
    Box2<T> CastBox3(const Box2<U> &a)
    {
    ...
    template <typename T, typename U>
    Box3<T> CastBox3(const Box3<U> &a)
    {
