...
void Demo::Tick(ID3D11DeviceContext *d3d_device_context, IDXGISwapChain *dxgi_swap_chain)
{
	...
	// Light Injection Pass
	{
		...
		// Draw Sponza
		{
			...
			d3d_device_context->DrawIndexedInstanced(this->m_sponza_index_count, static_cast<uint32_t>(VCT_VIEWPORT_DEPTH_DIRECTION_COUNT) * static_cast<uint32_t>(VCT_CLIPMAP_LEVEL_COUNT), 0U, 0U, 0U);
		}
	}
