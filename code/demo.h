...
class Demo
{
	...
	// Voxelization
	ID3D11Texture2D *m_voxelization_frame_buffer_render_target;
	ID3D11RenderTargetView *m_voxelization_frame_buffer_render_target_view;

	// Clipmap
	ID3D11Texture3D *m_clipmap_opacity[CLIPMAP_LEVEL_COUNT];
	ID3D11UnorderedAccessView *m_clipmap_opacity_unordered_access_view[CLIPMAP_LEVEL_COUNT];
	ID3D11ShaderResourceView *m_clipmap_opacity_shader_resource_view[CLIPMAP_LEVEL_COUNT];
	...
	// Voxelization
	ID3D11InputLayout *m_mesh_voxelization_vertex_attribute;
	ID3D11VertexShader *m_mesh_voxelization_vertex_shader;
	...
	ID3D11Buffer *m_voxelization_constant_buffer_frame;
	ID3D11Buffer *m_voxelization_constant_buffer_object;
	// Visualization
