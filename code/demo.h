...
class Demo
{
	...
	// Light Injection
	ID3D11InputLayout *m_vct_light_injection_mesh_vertex_attribute;
	...
	ID3D11Buffer *m_vct_light_injection_constant_buffer_frame;
	ID3D11Buffer *m_vct_light_injection_constant_buffer_object;
	// Visualization
