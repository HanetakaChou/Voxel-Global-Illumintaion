...
#define BRX_VCT_CLIPMAP_LEVEL_COUNT (BRX_VCT_CLIPMAP_STACK_LEVEL_COUNT + BRX_VCT_CLIPMAP_MIP_LEVEL_COUNT)

#define BRX_VCT_VOXELIZATION_SAMPLE_COUNT 8

#define BRX_VCT_CLIPMAP_MAP_LEVEL_STRIDE (BRX_VCT_CLIPMAP_MAP_SIZE + 2)
#define BRX_VCT_CLIPMAP_MAP_DIRECTION_STRIDE (BRX_VCT_CLIPMAP_MAP_SIZE + 2)
