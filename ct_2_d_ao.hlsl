...
void main(VxgiFullScreenQuadOutput quadIn, in float4 gl_FragCoord : SV_Position, out float4 o_color : SV_Target0, out float4 o_confidence : SV_Target1)
{
    ...
    VxgiConeTracingResults cone = VxgiTraceCone(args, false, true);
    ...
    o_color.x = ambient;
    o_color.x = InfNaNOutputGuard(o_color.x);
